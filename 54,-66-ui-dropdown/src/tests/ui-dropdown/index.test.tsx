...
// test('ui-dropdown: should change background color to red', async function (context) {
//   customAddEntity.clean()
//   clicked = false
//   CustomReactEcsRenderer.destroy()
//   CustomReactEcsRenderer.setUiRenderer(TestElementDropdown)
...
// test('ui-dropdown: should change background color to blue', async function (context) {
//   clicked = false
//   CustomReactEcsRenderer.destroy()
//   CustomReactEcsRenderer.setUiRenderer(TestElementDropdown)
//   await context.helpers.waitTicksUntil(() => {
...
// test('ui-dropdown: should change background color to green', async function (context) {
//   clicked = false
//   CustomReactEcsRenderer.destroy()
//   CustomReactEcsRenderer.setUiRenderer(TestElementDropdown)
//   await context.helpers.waitTicksUntil(() => {
