...
export function main() {
  ...
  setAsMovingPlatform(
    grandParentEntity,
    [Vector3.create(2, 7, 2), Vector3.create(-6, 7, 2)],
    30
  )
  ...
  createMovingPlatform(
    'models/movingPlatform.glb',
    [Vector3.create(20, 1.5, 6), Vector3.create(20, 1.5, 4)],
    5
  )
  ...
  setAsMovingPlatform(
    nftShapeEntity,
    [Vector3.create(8, 1.5, -24), Vector3.create(40, 1.5, -24)],
    180
  )
  ...
  setAsMovingPlatform(
    irregularMeshEntity,
    [Vector3.create(16, 1, -16), Vector3.create(16, 1, -8)],
    15
  )
  ...
  setAsMovingPlatform(
    audioSourceEntity,
    [Vector3.create(24, 1, -31), Vector3.create(24, 1, -33)],
    10
  )
  ...
  setAsMovingPlatform(
    textShapeEntity,
    [Vector3.create(30.5, 1, -16), Vector3.create(32.5, 1, -16)],
    5
  )
  ...
  setAsMovingPlatform(
    highEntity,
    [Vector3.create(8, 45, -8), Vector3.create(8, 46, -8)],
    2
  )
}
