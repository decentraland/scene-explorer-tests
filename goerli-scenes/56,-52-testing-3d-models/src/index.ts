...
GltfContainer.create(animatedspheremorph, {
  src: 'models/AnimatedSphereMorph.glb'
})
...
GltfContainer.create(riggeddracoanimation, {
  src: 'models/RiggedDracoAnimation.glb'
})
