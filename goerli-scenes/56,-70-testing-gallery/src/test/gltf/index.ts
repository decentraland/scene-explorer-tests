...
export function testGltfs(position: Vector3) {
  ...
  gltfTimer.addRange(0, 3, 1, (g_i, i) => {
    ...
    post.displayText(
      `[${g_i}] (StartCoin) collisionMask: invisible=0, visible=${i}`
    )
  })
  ...
  gltfTimer.addRange(0, 3, 1, (g_i, i) => {
    ...
    post.displayText(
      `[${g_i}] (StartCoin) collisionMask: invisible=${i}, visible=0`
    )
  })
  ...
  gltfTimer.addRange(0, 3, 1, (g_i, i) => {
    ...
    post.displayText(
      `[${g_i}] (Zombie) collisionMask: invisible=0, visible=${i}`
    )
  })
  ...
  gltfTimer.addRange(0, 3, 1, (g_i, i) => {
    ...
    post.displayText(
      `[${g_i}] (Zombie) collisionMask: invisible=${i}, visible=0`
    )
  })
}
